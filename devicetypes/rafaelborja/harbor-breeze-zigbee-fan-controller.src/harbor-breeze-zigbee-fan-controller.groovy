/*
 *  Harbor Breeze Zigbee Fan Controller
 *  
...
metadata {
	definition(name: "Harbor Breeze Zigbee Fan Controller", namespace: "rafaelborja", author: "Rafael Borja", ocfDeviceType: "oic.d.fan", genericHandler: "Zigbee") {    
...
def createLightChild() {
    ...
    if (!childDevice) {  
		...
		childDevice = addChildDevice("Harbor Breeze Zigbee Fan - Light Child Device", "${device.deviceNetworkId}-Light", null,[completedSetup: true,
