/**
 *  Harbor Breeze Zigbee Fan Controller - Light Child Device
 *
 ...
 */
metadata {
	definition (name: "Harbor Breeze Zigbee Fan - Light Child Device", namespace: "rafaelborja", ocfDeviceType:"oic.d.light", author: "Rafael Borja", vid: "generic-dimmer") {
		capability "Switch"
		capability "Actuator"
		capability "Sensor"
        capability "Refresh"
